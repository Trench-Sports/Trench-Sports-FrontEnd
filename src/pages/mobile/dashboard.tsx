  ...
  return (
    ...
    >
      ...
      {actionSheetAthlete && (() => {
        ...
        type Action = { label: string; icon: string; accent?: boolean; onClick: () => void };
            ...
            <div style={{
              ...
              <div style={{ display: "flex", flexDirection: "column", gap: 6 }}>
                {actions.map((act) => (
                  ...
                  >
                    <span style={{ fontSize: 18, lineHeight: 1, width: 24, textAlign: "center" }}>{act.icon}</span>
                    {act.label}
                  </button>
                ))}
              </div>
              ...
              {!recentSessionsLoading && recentSessions.length > 0 && (() => {
                ...
                return (
                  <div style={{ display: "flex", flexDirection: "column", gap: 8, marginBottom: 14 }}>
                    ...
                    {/* ── Row 2: Mode pills — equal-width cells that wrap to a
                        second line on narrow widths so longer labels like
                        "Accuracy" / "Reaction" / "Target" never clip. The
                        gap shorthand applies vertically between wrapped rows
                        too, so the layout stays tidy at every breakpoint. */}
                    <div style={{
                      display: "flex",
                      flexWrap: "wrap",
                      width: "100%",
                      ...
                      {([
                        ...
                        return (
                          <button
                            ...
                            style={{
                              // Min basis of 78px keeps "Accuracy"/"Reaction"
                              // legible without truncation. When the card is
                              // wider than ~6×78px the pills share the row
                              // equally; below that, the row wraps so labels
                              // stay readable instead of getting clipped.
                              flex: "1 1 78px",
                              minWidth: 0,
                              display: "flex",
                              alignItems: "center",
